<template>
  <div class="w-full mx-auto">
    <div
      class="bg-gray-50 border border-b-0 border-gray-300 rounded-t-md dark:bg-[#222] dark:border-gray-800"
    >
      <button
        type="button"
        ...
        :class="
          editing
            ? 'dark:hover:text-indigo-500 hover:text-indigo-500 text-indigo-500'
            : ''
        "
        @click="editing = true"
      >
    ...
    >
      <textarea
        v-if="editing"
        v-model="md"
        class="w-full h-full block p-4 outline-none resize-none dark:bg-[#1c1c1c]"
